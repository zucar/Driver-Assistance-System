...
namespace RControl {
    ...
    template<typename Num> Num DECLAR_LIB calcZ4(const Num&  d , const Num&  s , const Num&  thetaE  , const Num&  phi   , const Num& L  )  ;
    template<typename Num> Num DECLAR_LIB controlSignal_V2(const Num&  v1  ,const  Num& k2,const  Num& k3,const Num& K4,const  Num& k4 ,const  Num& z2,const  Num& z3,const  Num& z4);
...
template<typename Num> Num clacZ4(const Num&  d , const Num&  s , const Num&  thetaE  , const Num&  phi   , const Num& L , const Num& curvature , const Num& curvatureDF )
    {
...
template<typename Num> Num controlSignal_V2(const Num&  v1  ,const  Num& k2,const  Num& k3,const Num& K4,const  Num& k4 ,const  Num& z2,const  Num& z3,const  Num& z4){
