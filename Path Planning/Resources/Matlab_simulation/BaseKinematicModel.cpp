 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Nov 12 00:56:37 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME BaseKinematicModel
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          9
/* Input Port  0 */
#define IN_PORT_0_NAME      radius
...
/* Input Port  2 */
#define IN_PORT_2_NAME      distanceLR
...
/* Input Port  3 */
#define IN_PORT_3_NAME      angularVR
...
/* Input Port  4 */
#define IN_PORT_4_NAME      angularVL
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      longVeloc
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      rotationalVelocity
...
#define SOURCEFILES "__SFB__libs/PathTracking.dll__SFB__libs/kinematics.obj__SFB__libs/cardescription.obj__SFB__libs/kinematicmodel.obj"
#define PANELINDEX           6
...
extern void BaseKinematicModel_Outputs_wrapper(const real_T *radius,
			const real_T *length,
...
{
    const real_T   *radius  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *length  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *distanceLR  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *angularVR  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *angularVL  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *u1  = (const real_T*) ssGetInputPortSignal(S,5);
    const real_T   *theta  = (const real_T*) ssGetInputPortSignal(S,6);
    const real_T   *u2  = (const real_T*) ssGetInputPortSignal(S,7);
    const real_T   *phie  = (const real_T*) ssGetInputPortSignal(S,8);
    real_T        *longVeloc  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *rotationalVelocity  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *dX  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *dY  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *dTheta  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *dPhie  = (real_T *)ssGetOutputPortRealSignal(S,5);

    BaseKinematicModel_Outputs_wrapper(radius, length, distanceLR, angularVR, angularVL, u1, theta, u2, phie, longVeloc, rotationalVelocity, dX, dY, dTheta, dPhie);
