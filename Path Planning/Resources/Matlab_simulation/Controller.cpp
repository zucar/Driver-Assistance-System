 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Jan 26 11:34:09 2018
*/
...
extern void Controller_Outputs_wrapper(const real_T *d,
			const real_T *thetaE,
			const real_T *s,
			const real_T *cS,
			const real_T *phie,
...
{
    const real_T   *d  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *thetaE  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *s  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *cS  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *phie  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *u1  = (const real_T*) ssGetInputPortSignal(S,5);
    const real_T   *cDE  = (const real_T*) ssGetInputPortSignal(S,6);
    real_T        *v2  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *V1  = (real_T *)ssGetOutputPortRealSignal(S,1);
    ...
    const real_T  *K2  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *K3  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *K4  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const real_T  *L  = (const real_T *)mxGetData(PARAM_DEF3(S));

    Controller_Outputs_wrapper(d, thetaE, s, cS, phie, u1, cDE, v2, V1, K2, p_width0, K3, p_width1, K4, p_width2, L, p_width3);
